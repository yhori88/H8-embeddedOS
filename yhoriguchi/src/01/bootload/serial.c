...
#define SERIAL_SCI_NUM 3 /* The number of SCI */
...
int serial_init(int index) {
	...
	sci->scr = 0;
	sci->smr = 0;
	sci->brr = 64; /* 20MHz’¤Î’¥¯’¥í’¥Ã’¥¯’¤«’¤é9600bps’¤ò’À¸’À®(25MHz’¤Î’¾ì’¹ç’¤Ï80’¤Ë’¤¹’¤ë) */
	sci->scr = H8_3069F_SCI_SCR_RE | H8_3069F_SCI_SCR_TE; /* ’Á÷’¼õ’¿®’²Ä’Ç½ */
	sci->ssr = 0;
